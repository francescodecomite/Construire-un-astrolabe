...
\definecolor{Universite}{RGB}{174,37,115}

   \setbeamercolor{item projected}{bg=Universite}

\setbeamercolor{title}{bg=Universite}
\setbeamercolor{part title}{bg=Universite}
\setbeamercolor{frametitle}{bg=Universite}
%\setbeamercolor{structure}{bg=Universite}
\setbeamercolor{block title}{bg=Universite}
%\setbeamercolor{title}{fg=white,bg=!181!0!103}

\setbeamercolor{section in head/foot}{bg=Universite}
